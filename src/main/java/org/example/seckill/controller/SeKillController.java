...
//    private MQSender mqSender;
    ...
    public String doSeckill(Model model,Long goodsId,HttpServletRequest request, HttpServletResponse response, @CookieValue("userTicket") String ticket){
...
//        User user = (User)session.getAttribute(ticket);
        ...
        SeckillOrder seckillOrderServiceOne = seckillOrderService.getOne(new QueryWrapper<SeckillOrder>().eq("user_id", user.getId()).eq("goods_id", goods.getId()));
